...
class TokenConverter:
    ...
    BAD_TOKENS = frozenset(
        ["com", "http", "https", "icon", "images", "img", "js", "net", "news", "www"]
    )
    ...
    def regex_to_tokens(s: str) -> typing.MutableSequence[Token]:
        ...
        for match in TokenConverter.REGEX_TOKEN_RE.finditer(s):
            ...
            if TokenConverter.REGEX_BAD_PREFIX.search(
                prefix
            ) or TokenConverter.REGEX_BAD_SUFFIX.search(suffix):
    ...
    def generic_filter_to_tokens(
        s: str, allow_left: bool, allow_right: bool
    ) -> typing.MutableSequence[Token]:
