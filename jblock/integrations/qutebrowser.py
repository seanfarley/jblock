...
def jblock_update(quiet=False):
    ...
    for l in lists:
        r = urllib.request.Request(l.toString(), headers={"User-Agent": "Mozilla/5.0"})
...
def jblock_intercept(info: interceptor.Request):
    ...
    options = {
        ...
        "subdocument": resource_type
        in {interceptor.ResourceType.sub_frame, interceptor.ResourceType.sub_resource},
