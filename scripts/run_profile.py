...
def parse_args():
    ...
    parser.add_argument(
        ...
        metavar="TOOL",
        action="store",
        choices=["kcachegrind", "snakeviz", "gprof2dot", "tuna", "none"],
        default="snakeviz",
    ...
    parser.add_argument(
        "--profile-test", action="store_true", help="Run pytest instead of program"
    )
...
def main():
    ...
    if args.profile_tool == "none":
        ...
        subprocess.run(
            ["pyprof2calltree", "-k", "-i", profilefile, "-o", callgraphfile]
        )
